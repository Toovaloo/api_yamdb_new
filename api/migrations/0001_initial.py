# Generated by Django 3.0.5 on 2021-06-16 19:13
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'обычный пользователь'), ('moderator', 'модератор'), ('admin', 'администратор')], default='user', max_length=9)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year', models.IntegerField(db_index=True, null=True, verbose_name='Год выпуска')),
